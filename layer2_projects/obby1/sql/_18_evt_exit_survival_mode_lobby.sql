-- L2 obby1_layer2.evt_exit_survival_mode_lobby  <-  exit_survival_mode_lobby  (20260901)
CREATE TABLE IF NOT EXISTS `obby1_layer2.evt_exit_survival_mode_lobby`
...
WHERE e.event_name = 'exit_survival_mode_lobby'
LIMIT 0;

DELETE FROM `obby1_layer2.evt_exit_survival_mode_lobby`
WHERE event_date = DATE('2026-09-01');

INSERT INTO `obby1_layer2.evt_exit_survival_mode_lobby`
SELECT
    e.user_pseudo_id,
    e.user_id,
    e.event_name,
