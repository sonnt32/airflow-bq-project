-- L2 obby1_layer2.evt_click_shop_button  <-  click_shop_button  (20260901)
CREATE TABLE IF NOT EXISTS `obby1_layer2.evt_click_shop_button`
...
WHERE e.event_name = 'click_shop_button'
LIMIT 0;

DELETE FROM `obby1_layer2.evt_click_shop_button`
WHERE event_date = DATE('2026-09-01');

INSERT INTO `obby1_layer2.evt_click_shop_button`
SELECT
    e.user_pseudo_id,
    e.user_id,
    e.event_name,
