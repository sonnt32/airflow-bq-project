-- L2 obby1_layer2.evt_loading  <-  loading  (20260901)
CREATE TABLE IF NOT EXISTS `obby1_layer2.evt_loading`
...
WHERE e.event_name = 'loading'
LIMIT 0;

DELETE FROM `obby1_layer2.evt_loading`
WHERE event_date = DATE('2026-09-01');

INSERT INTO `obby1_layer2.evt_loading`
SELECT
    e.user_pseudo_id,
    e.user_id,
    e.event_name,
