-- L2 obby1_layer2.evt_session_start  <-  session_start  (20260901)
CREATE TABLE IF NOT EXISTS `obby1_layer2.evt_session_start`
...
DELETE FROM `obby1_layer2.evt_session_start`
WHERE event_date = DATE('2026-09-01');

INSERT INTO `obby1_layer2.evt_session_start`
SELECT
    e.user_pseudo_id,
    e.user_id,
    e.event_name,
