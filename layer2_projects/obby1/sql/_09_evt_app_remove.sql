-- L2 obby1_layer2.evt_app_remove  <-  app_remove  (20260901)
CREATE TABLE IF NOT EXISTS `obby1_layer2.evt_app_remove`
...
DELETE FROM `obby1_layer2.evt_app_remove`
WHERE event_date = DATE('2026-09-01');

INSERT INTO `obby1_layer2.evt_app_remove`
SELECT
    e.user_pseudo_id,
    e.user_id,
    e.event_name,
