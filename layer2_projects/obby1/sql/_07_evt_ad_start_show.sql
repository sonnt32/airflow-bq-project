-- L2 obby1_layer2.evt_ad_start_show  <-  ad_start_show  (20260901)
CREATE TABLE IF NOT EXISTS `obby1_layer2.evt_ad_start_show`
...
WHERE e.event_name = 'ad_start_show'
LIMIT 0;

DELETE FROM `obby1_layer2.evt_ad_start_show`
WHERE event_date = DATE('2026-09-01');

INSERT INTO `obby1_layer2.evt_ad_start_show`
SELECT
    e.user_pseudo_id,
    e.user_id,
    e.event_name,
