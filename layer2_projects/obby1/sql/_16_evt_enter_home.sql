-- L2 obby1_layer2.evt_enter_home  <-  enter_home  (20260901)
CREATE TABLE IF NOT EXISTS `obby1_layer2.evt_enter_home`
...
WHERE e.event_name = 'enter_home'
LIMIT 0;

DELETE FROM `obby1_layer2.evt_enter_home`
WHERE event_date = DATE('2026-09-01');

INSERT INTO `obby1_layer2.evt_enter_home`
SELECT
    e.user_pseudo_id,
    e.user_id,
    e.event_name,
